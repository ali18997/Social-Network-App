...
public class ChatActivity2 extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() == null) {
                    startActivity(new Intent(ChatActivity2.this, StartActivity.class));
                }
            }
        };
        ...
        if(!TextUtils.isEmpty(messageValue)){
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    newPost.child("time").setValue(DateFormat.getDateTimeInstance().format(new Date()));
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Message, MessageViewHolder> FBRA = new FirebaseRecyclerAdapter<Message, MessageViewHolder>(
            ...
            protected void populateViewHolder(MessageViewHolder viewHolder, Message model, int position) {
                ...
                viewHolder.setTimeMsg(model.getTimemsg());
            }
        };
    ...
    public static class MessageViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setTimeMsg(String time){
